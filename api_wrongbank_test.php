<?php
// 【测试版专用接口】独立数据文件 wrong_bank_data_test.json —— 与 api_wrongbank.php 完全隔离。
// 供「AI错题本-测试版」使用；正式错题库仍走 api_wrongbank.php。
...
const DATA_FILE  = __DIR__ . '/wrong_bank_data_test.json';   // 测试版独立数据（与正式库互不影响）
const BACKUP_DIR = __DIR__ . '/wrong_bank_test_backups';
